-- DzBuild - Supabase Database Setup (Clean Install)
-- Compatible with Prisma schema (using TEXT instead of ENUM)
...
CREATE TRIGGER update_craftsmen_updated_at BEFORE UPDATE ON "craftsmen" FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
CREATE TRIGGER update_construction_guides_updated_at BEFORE UPDATE ON "construction_guides" FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_videos_updated_at BEFORE UPDATE ON "videos" FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

-- ==================== DONE ====================

SELECT 'DzBuild database tables created successfully! ✅' AS message;
