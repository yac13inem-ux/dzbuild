...
export async function GET(request: NextRequest) {
  try {
    ...
    const transformed = filtered.map(c => ({
      ...
      nameFr: c.name_fr,
      type: c.type,
      company_type: c.type, // Add this for frontend compatibility
      logo: c.logo,
      ...
      review_count: c.review_count || 0, // Add this for frontend compatibility
      project_count: c.project_count || 0, // Add this for frontend compatibility
