...
export async function GET(request: NextRequest) {
  try {
    ...
    // Transform products to ensure category field exists for frontend compatibility
    const transformedProducts = products.map(p => ({
      ...p,
      category: p.category_id || p.category, // Ensure category field exists
      title: p.title || p.name, // Ensure title field exists
